...
#
# # Define the image with FastAPI installed
# image = modal.Image.debian_slim().pip_install("fastapi[standard]")
#
# # Create the Modal app
# app = modal.App(name="fastapi-test-app", image=image)
#
...
#     qty: int = 1
#
# # Create the function with a FastAPI endpoint
# @app.function()
# @modal.fastapi_endpoint(method="POST")
# def greet_user(item: Item):
#     return HTMLResponse(f"<html><body><h1>Hello, {item.name}! You ordered {item.qty} item(s).</h1></body></html>")
#
